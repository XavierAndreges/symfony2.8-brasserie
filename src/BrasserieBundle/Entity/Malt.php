 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="BrasserieBundle\Entity\MaltRepository")
 */
class Malt
{
     ...
     *
     * @Groups({"list", "quantite"})
     * @ORM\Column(name="dosage_max", type="integer", nullable=true)
     */
    private $dosageMax;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Empatage", mappedBy="malt")
     */
    private $empatage;
     ...
     * Set dosageMax
     *
     * @param integer $dosageMax
     * @return malt
     */
    public function setDosageMax($dosageMax)
    {
